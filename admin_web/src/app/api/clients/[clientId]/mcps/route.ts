...
import { setClientMcps } from "@/server/clients/application/commands/set-client-mcps";
...
export async function PUT(
    ...
    const parsedInput = setMcpsSchema.safeParse(body);
